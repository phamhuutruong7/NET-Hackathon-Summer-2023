  ...
  `webApp${projectShort}`,
  {
    ...
    siteConfig: {
      appSettings: [
        ...
        { name: "OpenAIServiceOptions__ApiKey", value: "" },
        { name: "OpenAIServiceOptions__DeploymentId", value: "" },
        { name: "OpenAIServiceOptions__ResourceName", value: "" },
        { name: "OpenAIServiceOptions__ProviderType", value: "" },
      ],
      alwaysOn: true,
